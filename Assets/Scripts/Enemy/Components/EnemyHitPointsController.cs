...
namespace ShootEmUp
{
    public sealed class EnemyHitPointsController : IDisposable
    {
        ...
        private EnemySpawnerController enemySpawnerComponent;

        private Dictionary<GameObject, int> hitPointsDict;


        public EnemyHitPointsController(
        ...
        public void SetSpawnerAndSubscribe(EnemySpawnerController spawner)
        {
