...
{
    [Serializable]
    public sealed class LoadStorageComponent
    {
        public LoadCapacityUpgradeConfig config;
        public Upgrade Upgrade {get; private set;}
        public LoadStoragePresenter Presenter {get; private set;}
            ...
            MoneyStorage moneyStorage)
        {
            ...
            {
                Debug.LogWarning("No LoadCapacityUpgradeConfig found");
            }
        }
        ...
        {
            Presenter = new LoadStoragePresenter(
                uiComponent.loadStorageCapacityView,
                Upgrade,
                moneyStorage);
