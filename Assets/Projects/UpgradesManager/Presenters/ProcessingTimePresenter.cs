...
{
    public sealed class ProcessingTimePresenter : Presenter
    {
        private readonly View _view;
        private readonly UpgradeProcessingTime _upgrade;
        private readonly IMoneyStorage _moneyStorage;

        public ProcessingTimePresenter(
            View view, 
            ...
            :base(view, moneyStorage, loadStorageUpgrade)
        {
            ...
            _upgrade = loadStorageUpgrade as UpgradeProcessingTime;
        }
